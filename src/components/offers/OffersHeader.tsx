...
const OffersHeader = () => {
  return (
    <div className="bg-headercolor">
      <PageHeader id={"oferta-header"}>Oferta</PageHeader>
      <div className=" relative flex flex-col md:flex-row  bg-headercolor   mb-4 md:mx-[5rem] my-5 rounded">
        <div className="absolute  flex flex-col  z-30 md:left-[10rem] md:right-[10rem] md:top-[25%] bg-triadgray bg-opacity-90 border-white border-4 rounded-xl h-full md:h-[20rem] justify-center">
          ...
          <p className=" w-full tracking-wide text-center text-xl font-[Lato] md:text-2xl text-amber-950  mx-2  sm:px-1 sm:py-1 indent-4 animate-fadeIn rounded-xl transition-transform duration-1000 ease-in-out  ">
        ...
        <div className=" w-full flex justify-center bg-headercolor ">
