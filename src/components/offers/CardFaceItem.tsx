...
const CardFaceItem = () => {
  ...
  return (
    ...
    {categoryFace.map((offerItem) => (
      <div
        key={offerItem.id}
        className=" h-[29rem]  my-6  md:mx-2 sm:h-[28rem] md:h-[30rem] lg:h-[30rem] xl:h-[30rem] 2xl:h-[42rem]  bg-white shadow-lg shadow-gray-400 animate-fadeIn rounded-xl   transition-transform xl:hover:z-30 duration-500 ease-in-out xl:hover:scale-[1.03]   2xl:w-[30rem]  "
      >
