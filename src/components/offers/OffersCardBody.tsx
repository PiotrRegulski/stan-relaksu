      ...
      <div className="flex justify-center w-full my-12 ">
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:gap-2 lg:gap-2 w-full ">
          {categoryBody.map((offerItem) => (
            <div
              key={offerItem.id}
              className="lg:mx-6 my-6 lg:w-auto  bg-white shadow-lg shadow-gray-500 animate-fadeIn rounded border-4 border-white transition-transform duration-200 ease-in-out hover:scale-[1.02] h-max"
            >
              <Link className="" href={`/offer/${offerItem.slug} `}>
                ...
                <div className="animate-fadeIn rounded border-4 border-white  w-full bg-white">
