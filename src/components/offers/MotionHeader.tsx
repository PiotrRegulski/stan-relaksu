...
const MotionHeader: React.FC<MotionHeaderProps> = ({ title, description }) => {
  ...
  return (
    ...
    ref={ref}
      ...
      className="relative  w-full sm:w-10/12 md:w-10/12 xl:w-2/3 2xl:w-2/3  bg-mainpeach sm:h-[12rem] md:h-[16rem] 2xl:h-[20rem] flex justify-center  items-center text-black sm:border-2 sm:border-l-0 sm:rounded-r-full py-4 md:py-2 "
    >
