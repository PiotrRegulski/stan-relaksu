...
const MotionHeader: React.FC<MotionHeaderProps> = ({ title, description }) => {
  return (
    <div className=" md:h-[21rem] flex w-full justify-center items-center transition-transform transform-gpu duration-300 ease-in-out">
      <div className="relative w-full md:w-full xl:w-full 2xl:w-full bg-mainpeach sm:h-[14rem] md:h-[16rem] 2xl:h-[18rem] flex justify-center items-center text-black md:border-2 md:border-l-0 md:rounded-r-full py-4 md:py-2 ">
