      ...
      <div className=" flex w-full flex-col justify-center items-center bg-white my-4 xl:my-16 ">
        <div className=" flex flex-col justify-center items-center md:w-full  ">
          <h1 className=" text-xl font-serif sm:text-2xl mx-auto xl:mx-4 font-bold px-2 py-2 text-center md:text-left">
            Gabinet terapii manualnej<br></br> ciała i twarzy - Stan Relaksu
          </h1>
          <p
            className={`${lato.className} text-lg lg:font-semibold font-serif  sm:text-xl  text-center   tracking-wide leading-10 animate-fadeIn transition-transform duration-1000 ease-in-out sm:pt-2 md:pt-4 px-3 sm:px-8 md:px-1 lg:px-8 lg:pt-0 2xl:pt-4 lg:my-6 2xl:mx-12 2xl:mt-4 `}
          >
            to terapeutyczne miejsce dla ciała stworzone &nbsp;z myślą o Tobie. <br></br> Osobie
            która chce o zadbać o swoje zdrowie, zwolnić i poczuć się lepiej.
