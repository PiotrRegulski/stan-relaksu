      ...
      <div className=" relative flex w-full bg-secondary ">
        ...
        <div className="flex flex-col  lg:basis-5/6  ">
          <div className="flex-row   md:my-4">
            <div className=" flex flex-col md:flex-row md:h-[20rem]  justify-center bg-secondary  md:mx-4 rounded-xl  shadow-primary shadow-lg ">
              ...
              <div className="flex w-full md:w-1/3  justify-center bg-secondary  shadow-lg md:shadow-[0px]  shadow-gray-400 md:shadow-0 ">
