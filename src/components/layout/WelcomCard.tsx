...
const WelcomCard = () => {
  return (
    ...
    >
      ...
      <div className=" absolute top-18 lg:top-[3em] z-39  lg:left-20 flex flex-col lg:shadow-xl lg:border-4 lg:border-white shadow-gray-400/75  lg:w-1/2 lg:h-min animate-fadeIn rounded-xl   transition-transform duration-1000 ease-in-out bg-gradient-to-r from-teal-500 via-teal-400/75 to-transparent bg-opacity-95 ">
        <div className=" container flex flex-col px-6 py-6">
          <article className={`${lato.className}  `}>
            <h2 className="font-bold text-xl xl:text-3xl text-white text-center    bg-opacity-95 lg:bg-opacity-25 px-2 py-2 ">
