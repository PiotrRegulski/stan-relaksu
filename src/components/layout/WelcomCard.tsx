  ...
  return (
    ...
    >
      <div className="  grid md:place-items-center  bg-cover md:bg-left bg-center  bg-my-bg-image h-[75vh] md:h-[60] w-screen md:w-2/3 rounded-md ">
        <section className=" md:absolute md:top-[3em] md:left-20 flex flex-col shadow-xl rounded border-4 border-white shadow-gray-400/75  md:w-1/2 md:h-min ">
          <div className="flex flex-col  justify-center  w-full mt-8 md:mt-20 ">
            ...
            <div className="flex justify-center gap-12 md:gap-24 py-3 mt-6 md:mt-2 ">
              <Link
                href="/about"
                className=" hover:shadow-xl shadow-md shadow-gray-400/75 text-xl lg:text-3xl  border-2 rounded border-black hover:border-white bg-white hover:bg-amber-400 px-6 py-2 font-bold  text-amber-700 hover:text-white  focus:outline-none focus:shadow-outline"
              >
                O mnie
              </Link>
              <Link
                href="/offer"
                className=" shadow-xl hover:shadow-md text-xl lg:text-3xl  border-2 rounded hover:border-amber-400 hover:bg-amber-500 bg-amber-400 px-6 py-2 font-bold  hover:text-white text-black focus:outline-none focus:shadow-outline"
              >
                Oferta
              </Link>
            </div>
