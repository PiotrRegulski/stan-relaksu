...
const WelcomCard = () => {
  return (
    <section id="welcome-card" className="relative  max-w-screen min-h-screen bg-gradient-to-t from-teal-300/50 via-teal-400/75 to-teal-300/50 overflow-hidden flex justify-end ">
      <div className="  grid md:place-items-center  bg-cover md:bg-left bg-center  bg-my-bg-image h-[90vh] md:h-[60] w-screen md:w-2/3 rounded-md ">
      <section className=" md:absolute md:top-3 md:left-20 flex flex-col shadow-xl rounded border-4 border-white shadow-gray-400/75  md:w-1/2 md:h-min ">
        <div className="flex flex-col  justify-center  w-full mt-8 md:mt-20 ">
          <article className={`${lato.className}  `}>
            {" "}
            <h2 className="font-bold text-xl   xl:text-5xl text-white  text-center md:text-left  bg-black bg-opacity-35 md:bg-opacity-10 leading-relaxed px-2 py-2 ">
            ...
            <p className="font-bold md:text-md xl:text-2xl text-md text-white  pt-4 text-center px-2 py-2 mt-36 md:mt-4 bg-black md:bg-opacity-10 bg-opacity-30 ">
