...
const NewCarousel = () => {
  ...
  return (
    <div className="relative w-full  h-[69vh] lg:h-[60vh] 2xl:h-[62vh]  lg:mt-[7rem] 2xl:mt-[7rem] animate-fadeIn mb-2 ">
      {" "}
      <Slider {...settings}>
        {images.map((image, index) => (
          <div key={index} className=" relative h-[69vh] lg:h-[60vh] 2xl:h-[60vh]  w-full ">
            <Image
              src={image.src}
              alt={image.alt}
            ...
            />
            <div className="absolute bottom-0 sm:bottom-0 md:bottom-2 lg:bottom-5 lg:left-5 xl:left-0 xl:bottom-5 right-0 2xl:bottom-5 2xl:left-0 p-2 w-full text-center rounded ">
              <div className="flex flex-col justify-center items-center xl:w-full 2xl:w-full bg-black bg-opacity-15">
                <div className="flex flex-col text-center text-white">
                  ...
                  <p
                    className={`${lato.className}  text-xs xl:text-xl 2xl:text-xl font-medium sm:px-[5rem] md:px-[7rem] lg:px-[14rem] xl:px-[15rem] 2xl:px-[20rem]`}
                  >
                    {image.description}
                  </p>
                  <div
