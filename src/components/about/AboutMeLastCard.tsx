  ...
  return (
    <div className="flex flex-col  mx:auto   md:mb-12      rounded-md animate-fadeIn   transition-transform duration-200 ease-in-out bg-white  ">
      <div className="flex flex-col  w-full  justify-center items-center ">
        <div className="flex flex-col w-full md:justify-center md:items-center py-6 xl:px-32 2xl:px-48">
          <h2
          ...
          <p className="text-justify text-lg md:text-xl xl:text-xl mx-auto my-2 px-2 py-3 lg:my-2 2xl:my-2 h-full lg:w-2/3">
