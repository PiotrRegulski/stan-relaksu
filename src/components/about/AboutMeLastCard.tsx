...
const AboutMeLastCard = () => {
  return (
    <div className="flex flex-col  mx:auto   md:mb-12 my-8   bg-my-bg-about bg-no-repeat bg-cover   rounded-md animate-fadeIn   transition-transform duration-200 ease-in-out  ">
      ...
      <div className="flex flex-col items-center justify-center  md:mx-2 md:my-2 px-4 py-3 md:py-12 lg:my-12 bg-white bg-opacity-80 shadow-md shadow-gray-400 ">
